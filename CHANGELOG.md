...
- [Pull request #1698: Fix documentation so that `id` option in date input is required](https://github.com/alphagov/govuk-frontend/pull/1698)
- [Pull request #1690: Don't unnecessarily self-close tags](https://github.com/alphagov/govuk-frontend/pull/1690)
